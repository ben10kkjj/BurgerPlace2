...
{
    [Area("Admin")]
    public class AdminPedidoItemlController : Controller
    {
        private readonly AppDbContext _context;

        public AdminPedidoItemlController(AppDbContext context)
        {
            _context = context;
        }

        // GET: Admin/AdminPedidoIteml
        ...
        // GET: Admin/AdminPedidoIteml/Details/5
        ...
        // GET: Admin/AdminPedidoIteml/Create
        ...
        // POST: Admin/AdminPedidoIteml/Create
        ...
        // GET: Admin/AdminPedidoIteml/Edit/5
        ...
        // POST: Admin/AdminPedidoIteml/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PedidoItemId,PedidoId,ItemId,Quantidade,Preco")] PedidoItem pedidoItem)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    double valorItem = _context.Itens.FirstOrDefault(m => m.ItemId == pedidoItem.ItemId).Preco;
        ...
        // GET: Admin/AdminPedidoIteml/Delete/5
        ...
        // POST: Admin/AdminPedidoIteml/Delete/5
